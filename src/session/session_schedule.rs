...
impl SessionSchedule {
  ...
  pub fn is_session_time(&self) -> bool {
    ...
    let weekly_start_datetime = weekly_start_date.and_time(today_start_datetime.time()).unwrap();
...
mod schedule_tests {
  ...
  fn test_between_session() {
    let schedule = SessionScheduleBuilder::default()
      ...
      .build()
      .unwrap();
    println!("time between {}", is_current_time_between(Tz::Asia__Kolkata, "9:00:01", "19:30:00"));
  }
}
